    ...
    return(
        <main>
            <section className=" py-28 bg-[#71556B] mx-aut px-[10%]">
                <h2 className="text-center font-bold text-[28px] xsm:text-4xl uppercase mb-8 text-white">Perfil de <span className=' letter-transparent text-[#EF7689]'>Competencias</span></h2>
                <article className="">
