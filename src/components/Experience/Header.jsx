                ...
                <div className='lg:w-1/2'>
                    ...
                    <div className=''>
                        ...
                        <div className='flex xs:flex-col sm:flex-row xs:gap-5 sm:gap-0 justify-between items-center mt-10 text-[18px]'>
                            <button className='btn button inline-flex w-max px-3 py-2 xsm:px-7 xsm:py-3'>Logros</button>
                            <button className='btn button inline-flex w-max px-3 py-2 xsm:px-7 xsm:py-3'>Clientes</button>
                        </div>
                    </div>
